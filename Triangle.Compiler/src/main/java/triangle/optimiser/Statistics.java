...
public class Statistics implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
	...
	public int BinaryExpressions = 0;
	public int WhileLoops = 0;
	public int IfElse = 0;

	public int getBinaryExpressions() {
		return BinaryExpressions;
	}
	public int getWhileLoops() { return WhileLoops; }
	public int getIfElse() { return IfElse; }
